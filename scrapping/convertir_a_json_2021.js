...
function parsearTextoAJSON_2021(anio) {
    ...
    // Lista de presas para 2021 (ajustada a los nombres en tu ejemplo)
    const listaPresas = [
        "Luis Donaldo Colosio", "Miguel Hidalgo y Costilla", "Josefa O. de Dominguez", 
    ...
    archivos.forEach(archivo => {
        ...
        listaPresas.forEach(nombrePresa => {
            // Regex ajustada para la estructura de 2021:
            // NOMBRE + CAPAC + ELEV + CAPAC + ELEV + TOTAL + %
            // El porcentaje en 2021 está en la 6ta posición numérica tras el nombre
