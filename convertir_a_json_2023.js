...
function parsearTextoAJSON_2023(anio) {
    ...
    archivos.forEach(archivo => {
        ...
        listaPresas.forEach(nombrePresa => {
            // Regex ajustada para la estructura de 2023, que sigue el formato consistente
