...
function parsearTextoAJSON_2024(anio) {
    ...
    archivos.forEach(archivo => {
        ...
        listaPresas.forEach(nombrePresa => {
            // Regex ajustada para 2024.
            // Nota: Algunos números tienen comas (ej: "3,202.2"), por lo que debemos manejar eso.
            // Regex busca: NOMBRE + CAPAC + ELEV + CAPAC + ELEV + TOTAL + %
