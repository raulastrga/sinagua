...
function parsearTextoAJSON_2022(anio) {
    ...
    archivos.forEach(archivo => {
        ...
        listaPresas.forEach(nombrePresa => {
            // Regex ajustada para la estructura de 2022, que es igual a años anteriores
